<template>
    <div class="container">
      <h2 class="text-center mb-4">LIFT AND ESCALATOR TRAINING ZONE</h2>
  ...
  export default {
    data() {
      return {
        floorplanImage: require('@/assets/Sub System and Icons/V2/Lift and Escalator Training Zone.png'), // Replace with your correct image path
        sensorData: [
          { label: 'Lift Motor Temperature', value: 42.6, unit: '°C' },
          { label: 'Escalator Motor Temperature', value: 39.8, unit: '°C' },
          { label: 'Lift Trips Today', value: 126, unit: 'trips' },
          { label: 'Escalator Runtime', value: 8.4, unit: 'hours' },
          { label: 'Lift Load', value: 48, unit: '%' },
          { label: 'Vibration', value: 1.7, unit: 'mm/s' },
        ],
        controls: [
          { name: 'Training Lift', isOn: true },
          { name: 'Training Escalator', isOn: true },
          { name: 'Shaft Ventilation', isOn: true },
          { name: 'Maintenance Mode', isOn: false },
        ],
      };
    },
    methods: {
