...
export default {
    data() {
        return {
            ...
            gatewayID: '24052003410036', // Hardcode the gateway for B05-11/12
            selectedDay: '',
            chartInstance: null,
            sensorData: {
                co2: null,
    ...
    `);
        ...
        async sendSwitchCommand(deviceEUI, switchStates) {
            const url = '/api/command/ws503/';   // ← same as previous working code
            ...
            try {
                ...
                if (sensor) {
                    sensor.isOnline = switch_states.some(x => x === 1); // like old code
                }
            } catch (error) {
