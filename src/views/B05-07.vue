...
export default {
  data() {
    return {
      ...
      gatewayID: '24052003410035', // Hardcode the gateway for B05-11/12
      selectedDay: '',
      chartInstance: null,
  ...
  methods: {
    ...
    async sendSwitchCommand(deviceEUI, switchStates) {
      ...
      // if switchStates are booleans, keep this line.
      // if they’re already 0/1, you can skip the map.
